...
ActiveRecord::Schema.define(version: 2021_11_21_021759) do
  ...
  create_table "stocks_orders", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_stocks_orders_on_user_id"
  end

  create_table "stocks_portfolios", force: :cascade do |t|
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_stocks_portfolios_on_user_id"
  end
